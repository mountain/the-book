...
后来读到 Ted Chiang 的《你一生的故事》，则深为外星异质文化带来的观念冲击而着迷。着迷什么呢？
在于—人们可以通过不同来重新审视自己。

我们惯常藏身于观念的硬壳里—有些观念创建已久，成为我们每个人思考的一部分；
当我们说到它，仅仅一个词汇脱口而出，压根没想这个词汇的意义；当重新尝试用观念创建者的角度来观察时，
我们才恍然发现一个非常简单观念的背后，对它的思考并不那么简单。

当遭遇不同的时候，恰恰是我们可以反省自己种种僵固思维的时刻。这是笔者在写本书时常常想到的，故以此为序。
